...
window.RISE_ADMIN_CONSOLE = async function({client,user,profile,root,report}) {
 ...
 root.innerHTML=`<section class="auth-card"><h2>管理工具</h2><p><a class="auth-button" href="#video-management">影音探索管理</a></p><div class="auth-actions"><a class="auth-button" href="admin-review.html">教師與助教資格審核</a><a class="auth-button" href="resources.html?destination=science">科學探索教材管理</a><a class="auth-button" href="discussions.html?view=teacher">討論題管理</a></div></section>
...
if (statsButton) {
 ...
 if(window.RISE_VIDEO_MANAGER&&alive)await window.RISE_VIDEO_MANAGER({client,user,profile,root,report});
};

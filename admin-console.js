...
window.RISE_ADMIN_CONSOLE = async function({client,user,profile,root,report}) {
 ...
 root.innerHTML=`<section class="auth-card"><h2>管理工具</h2><div class="auth-actions"><a class="auth-button" href="assignments.html">作業與批閱管理</a><a class="auth-button" href="ta-training.html">助教培訓認證</a><a class="auth-button" href="competitions.html">競賽管理</a><a class="auth-button" href="learning-report.html">學習成效分析</a></div><p><a class="auth-button" href="admin-videos.html">影音探索管理</a></p><div class="auth-actions"><a class="auth-button" href="admin-review.html">教師與助教資格審核</a><a class="auth-button" href="resources.html?destination=science">科學探索教材管理</a><a class="auth-button" href="discussions.html?view=teacher">討論題管理</a></div></section>

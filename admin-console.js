...
window.RISE_ADMIN_CONSOLE = async function({client,user,profile,root,report}) {
 ...
 root.innerHTML=`<section class="auth-card admin-tools"><h2>管理工具</h2><section class="admin-tool-group" aria-labelledby="admin-tool-group-0"><h3 id="admin-tool-group-0">教學與活動</h3><div class="admin-tool-grid"><a class="admin-tool-link" href="admin-courses.html"><span class="admin-tool-copy"><strong>課程分類管理</strong><span>設定學生可選擇的課程與加入狀態</span></span><span class="admin-tool-arrow" aria-hidden="true">→</span></a><a class="admin-tool-link" href="assignments.html"><span class="admin-tool-copy"><strong>作業與批閱管理</strong><span>查看繳交、修訂歷程與批閱</span></span><span class="admin-tool-arrow" aria-hidden="true">→</span></a><a class="admin-tool-link" href="ta-training.html"><span class="admin-tool-copy"><strong>助教培訓認證</strong><span>管理培訓成果與內部認證</span></span><span class="admin-tool-arrow" aria-hidden="true">→</span></a><a class="admin-tool-link" href="competitions.html"><span class="admin-tool-copy"><strong>競賽管理</strong><span>管理投稿、評審與結果發布</span></span><span class="admin-tool-arrow" aria-hidden="true">→</span></a><a class="admin-tool-link" href="learning-report.html"><span class="admin-tool-copy"><strong>學習成效分析</strong><span>查看學習紀錄與統計</span></span><span class="admin-tool-arrow" aria-hidden="true">→</span></a></div></section><section class="admin-tool-group" aria-labelledby="admin-tool-group-1"><h3 id="admin-tool-group-1">內容與資格管理</h3><div class="admin-tool-grid"><a class="admin-tool-link" href="admin-videos.html"><span class="admin-tool-copy"><strong>影音探索管理</strong><span>新增影片與調整發布狀態</span></span><span class="admin-tool-arrow" aria-hidden="true">→</span></a><a class="admin-tool-link" href="resources.html?destination=science"><span class="admin-tool-copy"><strong>科學探索教材管理</strong><span>編輯文章、教材與主題</span></span><span class="admin-tool-arrow" aria-hidden="true">→</span></a><a class="admin-tool-link" href="discussions.html?view=teacher"><span class="admin-tool-copy"><strong>討論題管理</strong><span>發布討論題與查看回答</span></span><span class="admin-tool-arrow" aria-hidden="true">→</span></a><a class="admin-tool-link" href="admin-review.html"><span class="admin-tool-copy"><strong>教師與助教資格審核</strong><span>審核資格申請與證明附件</span></span><span class="admin-tool-arrow" aria-hidden="true">→</span></a></div></section></section>
...
const searchForm = $('#admin-search');
const prevButton = $('#admin-prev');
const nextButton = $('#admin-next');
const statsButton = $('#admin-stats-refresh');
